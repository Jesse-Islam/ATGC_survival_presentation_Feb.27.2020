...
```{r DataModel, echo=FALSE, warning=FALSE,message=FALSE,include=TRUE}
nobs <- nrow(data)
ftime <- data$d.time
...
col = "firebrick3", cex = 0.3)
legend("right", legend = c("Death"),
...
abCbFull=casebase::absoluteRisk(cbFull,time = seq(1,max(abKMcompare[,1]), 1),newdata = newData , s="lambda.1se",method=c("numerical"))
